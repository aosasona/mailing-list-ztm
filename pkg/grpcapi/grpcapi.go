...
func (s *MailServer) GetEmail(
	ctx context.Context,
	req *pb.GetEmailRequest,
...
func (s *MailServer) GetEmailBatch(
	ctx context.Context,
	req *pb.GetEmailBatchRequest,
) (*pb.GetEmailBatchResponse, error) {
	log.Printf("gRPC GetEmails: %v\n", req)
	params := mdb.GetEmailsParams{
		Page:  int(req.Page),
		Count: int(req.Count),
	}

	mdbEntries, err := mdb.GetEmails(s.db, params)
	if err != nil {
...
func (s *MailServer) CreateEmail(
	ctx context.Context,
	req *pb.CreateEmailRequest,
) (*pb.EmailResponse, error) {
...
func (s *MailServer) DeleteEmail(
	ctx context.Context,
	req *pb.DeleteEmailRequest,
) (*pb.EmailResponse, error) {
...
func Serve(db *sql.DB, bind string) {
	...
	if err != nil {
		log.Fatalf("gRPC server error: reason: %v\n", err)
	}
